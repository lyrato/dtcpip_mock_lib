...
mpe_Error mock_mutexNew(mock_Mutex *mutex)
{
    ...
    if ((ec = mock_memAllocP(MPE_MEM_DEFAULT, sizeof(pthread_mutex_t),
...
mpe_Error mock_mutexDelete(mock_Mutex mutex)
{
    ...
    mock_memFreeP(MPE_MEM_DEFAULT, mutex);
        ...
        mock_Cond *condition)
{
    ...
    if ((ec = mock_memAllocP(MPE_MEM_DEFAULT, sizeof(struct os_Cond_s),
...
mpe_Error mock_condDelete(mock_Cond cond)
{
    ...
    mock_memFreeP(MPE_MEM_DEFAULT, cond);
    return MPE_SUCCESS;
}
